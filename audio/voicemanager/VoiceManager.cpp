...
VoiceManager::VoiceManager()
{
    ...
    m_pEnvelopeReleaseTime = std::make_shared<Param>(0.01, 2.00, 0.01);
    m_pEnvelopeDecayTime = std::make_shared<Param>(0.01, 0.99, 0.01);
    m_pEnvelopeSustainAmplitude = std::make_shared<Param>(0.0,1.0,1.0);
    
    m_pFilterEnvelopeAttackTime = std::make_shared<Param>(0.01, 0.99, 0.01);
    m_pFilterEnvelopeReleaseTime = std::make_shared<Param>(0.01, 2.00, 0.01);
    m_pFilterEnvelopeDecayTime = std::make_shared<Param>(0.01, 0.99, 0.01);
