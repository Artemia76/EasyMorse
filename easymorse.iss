...
#define Build
#define Dummy
#define ApplicationName "EasyMorse"
#define BaseDir  ".\"
#define ApplicationExeName "easymorse.exe"
...
#define ApplicationURL "https://https://bitbucket.org/Artemia/easymorse/"
#define InstallFileName "easymorse_" + str(Major) +"_" + str(Minor) + "_" + str(Build) + "_win"
